...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><h5>Editar examen de {{$exam->patient->name}} {{$exam->patient->surname}}</h5></div>
                    ...
                    <div class="card-body">
                        ...
                        @elseif($exam->tipoExam=='infantil')
                            <div>
                                ...
                                {!! Form::text('aspectoGeneral',$exam->aspectoGeneral, ['class'=>'form-control','maxlength'=>"255",'required']) !!}
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                {!! Form::text('anomaliaForma',$exam->anomaliaForma, ['class'=>'form-control','maxlength'=>"255",'required']) !!}
                            </div>
                            <div>
                                {!!  Form::label('anomaliaTamaño' , 'Anomalía en tamaño: *') !!}
                                {!! Form::text('anomaliaTamaño',$exam->anomaliaTamaño, ['class'=>'form-control','maxlength'=>"255",'required']) !!}
                            </div>

                        @elseif($exam->tipoExam=='periodoncial')
                            <div>
                                {!!  Form::label('indicePlaca' , 'Índice de placa:') !!}
                                {!! Form::number('indicePlaca', $exam->indicePlaca,['class' => 'form-control','max'=>"100",'min'=>'0','step'=>'0.01']) !!}
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                {!! Form::select('biotipo',array('normal'=>'Normal','fino'=>'Fino','grueso'=>'Grueso'), $exam->biotipo,['class' => 'form-control','required']) !!}
                            </div>
                        ...
                        @elseif($exam->tipoExam=='evOrto')
                            <div>
                                ...
                                {!!  Form::select('orto_id',$ortodoncia,null, ['class' => 'form-control']) !!}
                            </div>
                            <div>
