                    ...
                    <div class="card-body">
                        ...
                        @elseif($exam->tipoExam=='infantil')
                            <div>
                                ...
                                {!! Form::text('aspectoGeneral',$exam->aspectoGeneral, ['class'=>'form-control','maxlength'=>"191",'required']) !!}
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                {!! Form::text('anomaliaForma',$exam->anomaliaForma, ['class'=>'form-control','maxlength'=>"191",'required']) !!}
                            </div>
                            <div>
                                {!!  Form::label('anomaliaTamaño' , 'Anomalía en tamaño: *') !!}
                                {!! Form::text('anomaliaTamaño',$exam->anomaliaTamaño, ['class'=>'form-control','maxlength'=>"191",'required']) !!}
                            </div>
